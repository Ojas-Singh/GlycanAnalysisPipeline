...
input_path = "dummy_data_dir"
output_path = "dummy_database"
update = True
...
def get_md_info(glycam):
    latest_inventory = "GlycoShape_Inventory.csv"
...
def iupac2sugarbase(iupac):
    sugarbase = pd.read_csv("v7_sugarbase.csv")
...
os.system("bash GlycoShape_zip.sh")
