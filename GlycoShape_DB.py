...
def get_md_info(glycam):
    latest_inventory = "/mnt/database/test_data/GlycoShape_Inventory.csv"
...
def get_clusters_alpha(glycam):
    for conf in ["alpha"]: 
        ...
        cluster_occupancies = []
        # Read in PDB files
        os.chdir(os.path.join(config.input_path,f"{glycam}/clusters/{conf}/"))
        files = glob.glob("*pdb")
        if len(files) == 0:
...
glycoshape_files = glob.glob(os.path.join(config.input_path,"*OH"))
...
for glycam, i in zip(glycoshape_list,tqdm(range(len(glycoshape_list)))):
    ...
    if (os.path.exists(os.path.join(config.output_path,iupac)) and config.update==False):
        continue
    if (os.path.exists(os.path.join(config.output_path,iupac)) and config.update==True):
            shutil.rmtree(os.path.join(config.output_path,iupac))
    os.mkdir(os.path.join(config.output_path,iupac))
    print(iupac)
    ...
    if glytoucan == None:
        ...
        no_glytoucan_glycoct.append(glycoct)
    ...
    if (wurcs in wurcs_check_list) and (wurcs != None):
        ...
        if glycam_tidy == "DManpa1-3[DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc":
            oxford = "M3"
        elif glycam_tidy == "DManpa1-3[DManpa1-6]DManpa1-6[DManpa1-3]DManpb1-4DGlcpNAcb1-4DGlcpNAc":
            oxford = "M5"
        elif (glycam_tidy=="DManpa1-3[DManpa1-3[DManpa1-2DManpa1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy=="DManpa1-2DManpa1-3[DManpa1-3[DManpa1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy=="DManpa1-3[DManpa1-2DManpa1-3[DManpa1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc"):
            oxford = "M6"
        elif (glycam_tidy == "DManpa1-3[DManpa1-2DManpa1-3[DManpa1-2DManpa1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy=="DManpa1-2DManpa1-2DManpa1-3[DManpa1-3[DManpa1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy=="DManpa1-2DManpa1-3[DManpa1-2DManpa1-3[DManpa1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy == "DManpa1-2DManpa1-3[DManpa1-3[DManpa1-2DManpa1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc"):
            oxford = "M7"
        elif (glycam_tidy == "DManpa1-2DManpa1-3[DManpa1-2DManpa1-3[DManpa1-2DManpa1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy=="DManpa1-2DManpa1-2DManpa1-3[DManpa1-2DManpa1-3[DManpa1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy=="DManpa1-2DManpa1-2DManpa1-3[DManpa1-3[DManpa1-2DManpa1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc"):
            oxford = "M8"
        elif glycam_tidy == "DManpa1-2DManpa1-2DManpa1-3[DManpa1-2DManpa1-3[DManpa1-2DManpa1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc":
            oxford = "M9"
        elif glycam_tidy == "DGlcpNAcb1-2DManpa1-3[DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc":
            oxford = "A2"
        elif (glycam_tidy == "DGalpb1-4DGlcpNAcb1-2DManpa1-3[DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy == "DGlcpNAcb1-2DManpa1-3[DGalpb1-4DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc"):
            oxford = "A2G1"
        elif glycam_tidy == "DGalpb1-4DGlcpNAcb1-2DManpa1-3[DGalpb1-4DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc":
            oxford = "A2G2"
        elif (glycam_tidy == "DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-3DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy == "DNeup5Aca2-3DGalpb1-4DGlcpNAcb1-2DManpa1-3[DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy == "DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-6DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy == "DNeup5Aca2-6DGalpb1-4DGlcpNAcb1-2DManpa1-3[DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc"):
            oxford = "A2G2S1"
        elif (glycam_tidy == "DNeup5Aca2-3DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-3DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy == "DNeup5Aca2-6DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-6DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy == "DNeup5Aca2-6DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-3DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy == "DNeup5Aca2-3DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-6DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc"):
            oxford = "A2G2S2"
        elif glycam_tidy == "DGlcpNAcb1-2DManpa1-3[DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4[LFucpa1-6]DGlcpNAc":
            oxford = "FA2"
        elif (glycam_tidy == "DGalpb1-4DGlcpNAcb1-2DManpa1-3[DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4[LFucpa1-6]DGlcpNAc") or (glycam_tidy == "DGlcpNAcb1-2DManpa1-3[DGalpb1-4DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4[LFucpa1-6]DGlcpNAc"):
            oxford = "FA2G1"
        elif glycam_tidy == "DGalpb1-4DGlcpNAcb1-2DManpa1-3[DGalpb1-4DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4[LFucpa1-6]DGlcpNAc":
            oxford = "FA2G2"
        elif (glycam_tidy == "DNeup5Aca2-3DGalpb1-4DGlcpNAcb1-2DManpa1-3[DGalpb1-4DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4[LFucpa1-6]DGlcpNAc") or (glycam_tidy == "DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-3DGalpb1-4DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4[LFucpa1-6]DGlcpNAc") or (glycam_tidy == "DNeup5Aca2-6DGalpb1-4DGlcpNAcb1-2DManpa1-3[DGalpb1-4DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4[LFucpa1-6]DGlcpNAc") or (glycam_tidy == "DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-6DGalpb1-4DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4[LFucpa1-6]DGlcpNAc"):
            oxford = "FA2G2S1"
        elif (glycam_tidy == "DNeup5Aca2-3DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-3DGalpb1-4DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4[LFucpa1-6]DGlcpNAc") or (glycam_tidy == "DNeup5Aca2-3DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-6DGalpb1-4DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4[LFucpa1-6]DGlcpNAc") or (glycam_tidy == "DNeup5Aca2-6DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-6DGalpb1-4DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4[LFucpa1-6]DGlcpNAc") or (glycam_tidy == "DNeup5Aca2-6DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-3DGalpb1-4DGlcpNAcb1-2DManpa1-6]DManpb1-4DGlcpNAcb1-4[LFucpa1-6]DGlcpNAc"):
            oxford = "FA2G2S2"
        elif (glycam_tidy == "DNeup5Aca2-3DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-3DGalpb1-4DGlcpNAcb1-2[DNeup5Aca2-3DGalpb1-4DGlcpNAcb1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy == "DNeup5Aca2-6DGalpb1-4DGlcpNAcb1-2DManpa1-3[DNeup5Aca2-6DGalpb1-4DGlcpNAcb1-2[DNeup5Aca2-6DGalpb1-4DGlcpNAcb1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc"):
            oxford = "A3G3S3"
        elif (glycam_tidy == "DGalpb1-4DGlcpNAcb1-2DManpa1-3[DGalpb1-4DGlcpNAcb1-2[DGalpb1-4DGlcpNAcb1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc") or (glycam_tidy == "DGalpb1-4DGlcpNAcb1-2DManpa1-3[DGalpb1-4DGlcpNAcb1-2[DGalpb1-4DGlcpNAcb1-6]DManpa1-6]DManpb1-4DGlcpNAcb1-4DGlcpNAc"):
            oxford = "A3G3"
        elif glycam_tidy == "DGlcpNAcb1-6[DGlcpNAcb1-2]DManpa1-6[DGlcpNAcb1-2DManpa1-3]DManpb1-4DGlcpNAcb1-4DGlcpNAc":
            oxford = "A3"
        elif glycam_tidy == "DGalpb1-4DGlcpNAcb1-6[DGalpb1-4DGlcpNAcb1-2]DManpa1-6[DGlcpNAcb1-4[DGlcpNAcb1-2]DManpa1-3]DManpb1-4DGlcpNAcb1-4DGlcpNAc":
            oxford = "A4G4"
        elif glycam_tidy == "DGlcpNAcb1-6[DGlcpNAcb1-2]DManpa1-6[DGlcpNAcb1-4[DGlcpNAcb1-2]DManpa1-3]DManpb1-4DGlcpNAcb1-4DGlcpNAc":
            oxford = "A4"
        else:
            oxford = None
        ...
        with open(os.path.join(config.output_path,f"{iupac}/{iupac}.json"), "w") as outfile:
            outfile.write(json_object)

        if glytoucan == None:
            glycoshape[ID] = glycan_data
        else:
            glycoshape[glytoucan] = glycan_data

        shutil.copytree(os.path.join(config.input_path,f"{glycam}/clusters/pack"), os.path.join(config.output_path,f"{iupac}/output"), dirs_exist_ok=True)
...
with open(os.path.join(config.output_path,"GLYCOSHAPE.json"), "w") as outfile:
    outfile.write(json_object)
...
with open(os.path.join(config.output_path,"GLYCAN_TYPE.json"), "w") as outfile:
    outfile.write(json_object)

with open(os.path.join(config.output_path,"sim_details.txt"), 'w') as f:
    f.write(f"num_sims = {len(sim_time)}\n")
    f.write(f"sim_length = {sum(sim_time)}")

d = {"IUPAC":no_glytoucan_iupac, "GlycoCT":no_glytoucan_glycoct}
